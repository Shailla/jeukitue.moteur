...
extern DECLSPEC AG_Textbox *AG_TextboxNew(void *, Uint, const char *);
...
extern DECLSPEC void AG_TextboxSetLabel(AG_Textbox *, const char *, ...);
...
#define AG_TextboxMapPosition(tb,x,y,pos,abs) AG_EditableMapPosition((tb)->ed,(x),(y),(pos),(abs))
#define AG_TextboxMoveCursor(tb,x,y,abs) AG_EditableMoveCursor((tb)->ed,(x),(y),(abs))
...
#define AG_TextboxCopyStringUCS4(tb,p,len) AG_EditableCopyStringUCS4((tb)->ed,(p),(len))
