...
__BEGIN_DECLS
extern DECLSPEC AG_ObjectClass rgTilesetClass;
extern DECLSPEC void RG_InitSubsystem(void);
extern DECLSPEC void RG_DestroySubsystem(void);
extern DECLSPEC RG_Tileset *RG_TilesetNew(void *, const char *, Uint);
extern DECLSPEC RG_Tile *RG_TilesetFindTile(RG_Tileset *, const char *);
#if 0
extern DECLSPEC RG_Sketch *RG_TilesetFindSketch(RG_Tileset *, const char *);
#endif
extern DECLSPEC RG_Pixmap *RG_TilesetFindPixmap(RG_Tileset *, const char *);
extern DECLSPEC RG_Anim *RG_TilesetFindAnim(RG_Tileset *, const char *);
extern DECLSPEC RG_Pixmap *RG_TilesetResvPixmap(void *, const char *, const char *);
extern DECLSPEC RG_Tile *RG_TilesetResvTile(void *, const char *, const char *);
