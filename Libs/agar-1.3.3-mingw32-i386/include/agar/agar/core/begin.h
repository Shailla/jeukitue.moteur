...
#ifdef _AGAR_CORE_BEGIN_H_
#error Nested inclusion of <agar/core/begin.h>
#endif
#define _AGAR_CORE_BEGIN_H_
...
# define _AGAR_CORE_DEFINED_UNSIGNED_TYPEDEFS
#endif
...
# define _AGAR_CORE_DEFINED_CDECLS
