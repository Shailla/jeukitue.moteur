...
extern DECLSPEC AG_Menu *AG_MenuNewGlobal(Uint);
extern DECLSPEC void AG_MenuScale(void *, int, int);
extern DECLSPEC void AG_MenuDraw(void *);
extern DECLSPEC AG_PopupMenu *AG_PopupNew(void *);
extern DECLSPEC void AG_PopupShow(AG_PopupMenu *);
extern DECLSPEC void AG_PopupShowAt(AG_PopupMenu *, int, int);
extern DECLSPEC void AG_PopupHide(AG_PopupMenu *);
extern DECLSPEC void AG_PopupDestroy(void *, AG_PopupMenu *);
extern DECLSPEC void AG_MenuItemFree(AG_MenuItem *);
extern DECLSPEC void AG_MenuItemFreeChildren(AG_MenuItem *);
extern DECLSPEC AG_Window *AG_MenuExpand(AG_Menu *, AG_MenuItem *, int, int);
extern DECLSPEC void AG_MenuCollapse(AG_Menu *, AG_MenuItem *);
...
extern DECLSPEC void AG_MenuSetIcon(AG_MenuItem *, AG_Surface *);
extern DECLSPEC void AG_MenuSetLabel(AG_MenuItem *, const char *, ...);
...
extern DECLSPEC AG_MenuItem *AG_MenuNode(AG_MenuItem *, const char *, AG_Surface *);
extern DECLSPEC AG_MenuItem *AG_MenuSeparator(AG_MenuItem *);
extern DECLSPEC AG_MenuItem *AG_MenuSection(AG_MenuItem *, const char *, ...);
extern DECLSPEC AG_MenuItem *AG_MenuAction(AG_MenuItem *, const char *, AG_Surface *, AG_EventFn, const char *, ...);
extern DECLSPEC AG_MenuItem *AG_MenuActionKb(AG_MenuItem *, const char *, AG_Surface *, SDLKey, SDLMod, AG_EventFn, const char *, ...);
extern DECLSPEC AG_MenuItem *AG_MenuTool(AG_MenuItem *, AG_Toolbar *, const char *, AG_Surface *, SDLKey, SDLMod, AG_EventFn, const char *, ...);
extern DECLSPEC AG_MenuItem *AG_MenuDynamicItem(AG_MenuItem *, const char *, AG_Surface *, AG_EventFn, const char *, ...);
extern DECLSPEC AG_MenuItem *AG_MenuDynamicItemKb(AG_MenuItem *, const char *, AG_Surface *, SDLKey, SDLMod, AG_EventFn, const char *, ...);
extern DECLSPEC AG_MenuItem *AG_MenuIntBoolMp(AG_MenuItem *, const char *, AG_Surface *, int *, int, AG_Mutex *);
extern DECLSPEC AG_MenuItem *AG_MenuInt8BoolMp(AG_MenuItem *, const char *, AG_Surface *, Uint8 *, int, AG_Mutex *);
extern DECLSPEC AG_MenuItem *AG_MenuIntFlagsMp(AG_MenuItem *, const char *, AG_Surface *, int *, int, int, AG_Mutex *);
extern DECLSPEC AG_MenuItem *AG_MenuInt8FlagsMp(AG_MenuItem *, const char *, AG_Surface *, Uint8 *, Uint8, int, AG_Mutex *);
extern DECLSPEC AG_MenuItem *AG_MenuInt16FlagsMp(AG_MenuItem *, const char *, AG_Surface *, Uint16 *, Uint16, int, AG_Mutex *);
extern DECLSPEC AG_MenuItem *AG_MenuInt32FlagsMp(AG_MenuItem *, const char *, AG_Surface *, Uint32 *, Uint32, int, AG_Mutex *);
