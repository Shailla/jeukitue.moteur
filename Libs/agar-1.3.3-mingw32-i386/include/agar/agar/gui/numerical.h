...
extern DECLSPEC AG_Numerical *AG_NumericalNew(void *, Uint, const char *, const char *);
...
extern DECLSPEC AG_Numerical *AG_NumericalNewUint8(void *, Uint, const char *, const char *, Uint8 *);
extern DECLSPEC AG_Numerical *AG_NumericalNewUint8R(void *, Uint, const char *, const char *, Uint8 *, Uint8, Uint8);
extern DECLSPEC AG_Numerical *AG_NumericalNewSint8(void *, Uint, const char *, const char *, Sint8 *);
extern DECLSPEC AG_Numerical *AG_NumericalNewSint8R(void *, Uint, const char *, const char *, Sint8 *, Sint8, Sint8);
extern DECLSPEC AG_Numerical *AG_NumericalNewUint16(void *, Uint, const char *, const char *, Uint16 *);
extern DECLSPEC AG_Numerical *AG_NumericalNewUint16R(void *, Uint, const char *, const char *, Uint16 *, Uint16, Uint16);
extern DECLSPEC AG_Numerical *AG_NumericalNewSint16(void *, Uint, const char *, const char *, Sint16 *);
extern DECLSPEC AG_Numerical *AG_NumericalNewSint16R(void *, Uint, const char *, const char *, Sint16 *, Sint16, Sint16);
extern DECLSPEC AG_Numerical *AG_NumericalNewUint32(void *, Uint, const char *, const char *, Uint32 *);
extern DECLSPEC AG_Numerical *AG_NumericalNewUint32R(void *, Uint, const char *, const char *, Uint32 *, Uint32, Uint32);
extern DECLSPEC AG_Numerical *AG_NumericalNewSint32(void *, Uint, const char *, const char *, Sint32 *);
extern DECLSPEC AG_Numerical *AG_NumericalNewSint32R(void *, Uint, const char *, const char *, Sint32 *, Sint32, Sint32);
extern DECLSPEC void AG_NumericalSizeHint(AG_Numerical *, const char *);
extern DECLSPEC void AG_NumericalSetValue(AG_Numerical *, double);
extern DECLSPEC void AG_NumericalAddValue(AG_Numerical *, double);
#define AG_NumericalSubValue(num,val) AG_NumericalAddValue((num),-(val))
extern DECLSPEC void AG_NumericalSetMin(AG_Numerical *, double);
...
extern DECLSPEC void AG_NumericalSetMax(AG_Numerical *, double);
...
extern DECLSPEC void AG_NumericalSetRange(AG_Numerical *, double, double);
#define AG_NumericalSetRangeInt(num, min, max) AG_NumericalSetRange((num),(double)(min),(double)(max))
#define AG_NumericalSetRangeFlt(num, min, max) AG_NumericalSetRange((num),(double)(min),(double)(max))
#define AG_NumericalSetRangeDbl(num, min, max) AG_NumericalSetRange((num),(min),(max))
extern DECLSPEC void AG_NumericalSetIncrement(AG_Numerical *, double);
...
#ifdef HAVE_64BIT
extern DECLSPEC AG_Numerical *AG_NumericalNewUint64(void *, Uint, const char *, const char *, Uint64 *);
extern DECLSPEC AG_Numerical *AG_NumericalNewUint64R(void *, Uint, const char *, const char *, Uint64 *, Uint64, Uint64);
extern DECLSPEC AG_Numerical *AG_NumericalNewSint64(void *, Uint, const char *, const char *, Sint64 *);
extern DECLSPEC AG_Numerical *AG_NumericalNewSint64R(void *, Uint, const char *, const char *, Sint64 *, Sint64, Sint64);
...
extern DECLSPEC AG_Numerical *AG_NumericalNewLongDbl(void *, Uint, const char *, const char *, long double *);
extern DECLSPEC long double AG_NumericalGetLongDbl(AG_Numerical *);
#endif
__END_DECLS
