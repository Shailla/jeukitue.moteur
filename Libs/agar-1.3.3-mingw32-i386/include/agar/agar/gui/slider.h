...
#ifdef HAVE_64BIT
extern DECLSPEC AG_Slider *AG_SliderNewUint64(void *, enum ag_slider_type, Uint, Uint64 *, Uint64 *, Uint64 *);
extern DECLSPEC AG_Slider *AG_SliderNewUint64R(void *, enum ag_slider_type, Uint, Uint64 *, Uint64, Uint64);
extern DECLSPEC AG_Slider *AG_SliderNewSint64(void *, enum ag_slider_type, Uint, Sint64 *, Sint64 *, Sint64 *);
extern DECLSPEC AG_Slider *AG_SliderNewSint64R(void *, enum ag_slider_type, Uint, Sint64 *, Sint64, Sint64);
#endif
...
extern DECLSPEC AG_Slider *AG_SliderNewLongDbl(void *, enum ag_slider_type, Uint, long double *, long double *, long double *);
extern DECLSPEC AG_Slider *AG_SliderNewLongDblR(void *, enum ag_slider_type, Uint, long double *, long double, long double);
#endif
