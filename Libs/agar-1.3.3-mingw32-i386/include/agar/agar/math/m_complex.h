...
extern DECLSPEC M_Complex M_ComplexLog(M_Complex);
extern DECLSPEC M_Complex M_ComplexExp(M_Complex);
extern DECLSPEC M_Complex M_ComplexPow(M_Complex, M_Complex);
extern DECLSPEC M_Complex M_ComplexSin(M_Complex);
extern DECLSPEC M_Complex M_ComplexCos(M_Complex);
extern DECLSPEC M_Complex M_ComplexTan(M_Complex);
extern DECLSPEC M_Complex M_ComplexCot(M_Complex);
extern DECLSPEC M_Complex M_ComplexAsin(M_Complex);
extern DECLSPEC M_Complex M_ComplexAcos(M_Complex);
extern DECLSPEC M_Complex M_ComplexAtan(M_Complex);
extern DECLSPEC M_Complex M_ComplexSinh(M_Complex);
extern DECLSPEC M_Complex M_ComplexAsinh(M_Complex);
extern DECLSPEC M_Complex M_ComplexCosh(M_Complex);
