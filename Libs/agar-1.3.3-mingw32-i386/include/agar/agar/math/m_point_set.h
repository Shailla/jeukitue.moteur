...
__BEGIN_DECLS
extern DECLSPEC void M_SortPoints2(M_PointSet2 *, enum m_point_sort_mode2);
extern DECLSPEC void M_SortPoints3(M_PointSet3 *, enum m_point_sort_mode3);
extern DECLSPEC void M_PointSetPrint2(M_PointSet2 *);
/*
