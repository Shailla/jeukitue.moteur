...
extern DECLSPEC M_Vector4 M_ReadVector4(AG_DataSource *);
extern DECLSPEC void M_ReadVector2v(AG_DataSource *, M_Vector2 *);
extern DECLSPEC void M_ReadVector3v(AG_DataSource *, M_Vector3 *);
extern DECLSPEC void M_ReadVector4v(AG_DataSource *, M_Vector4 *);
extern DECLSPEC void M_WriteVector2(AG_DataSource *, M_Vector2 *);
extern DECLSPEC void M_WriteVector3(AG_DataSource *, M_Vector3 *);
extern DECLSPEC void M_WriteVector4(AG_DataSource *, M_Vector4 *);
extern DECLSPEC M_Vector2 M_RealvToVector2(const M_Real *);
extern DECLSPEC M_Vector3 M_RealvToVector3(const M_Real *);
extern DECLSPEC M_Vector4 M_RealvToVector4(const M_Real *);
extern DECLSPEC M_Vector2 M_Vector3to2(M_Vector3);
extern DECLSPEC M_Vector4 M_Vector3to4(M_Vector3);
extern DECLSPEC M_Vector3 M_Vector2to3(M_Vector2);
