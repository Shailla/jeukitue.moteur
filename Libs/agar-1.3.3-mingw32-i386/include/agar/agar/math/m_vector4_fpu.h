...
extern DECLSPEC M_Vector4 M_VectorCross4_FPU(M_Vector4, M_Vector4, M_Vector4);
extern DECLSPEC M_Vector4 M_VectorCross4p_FPU(const M_Vector4 *, const M_Vector4 *, const M_Vector4 *);
extern DECLSPEC M_Vector4 M_VectorNormCross4_FPU(M_Vector4, M_Vector4, M_Vector4);
extern DECLSPEC M_Vector4 M_VectorNormCross4p_FPU(const M_Vector4 *, const M_Vector4 *, const M_Vector4 *);
