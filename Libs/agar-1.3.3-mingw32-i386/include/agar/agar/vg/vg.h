...
extern DECLSPEC const VG_NodeOps *VG_LookupClass(const char *);
extern DECLSPEC void VG_RegisterClass(const VG_NodeOps *);
extern DECLSPEC void VG_UnregisterClass(const VG_NodeOps *);
extern DECLSPEC void VG_NodeInit(void *, const VG_NodeOps *);
