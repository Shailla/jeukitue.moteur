...
extern DECLSPEC AG_Combo *AG_ComboNew(void *, Uint, const char *);
extern DECLSPEC void AG_ComboSizeHint(AG_Combo *, const char *, int);
extern DECLSPEC void AG_ComboSizeHintPixels(AG_Combo *, int, int);
extern DECLSPEC void AG_ComboSelect(AG_Combo *, AG_TlistItem *);
extern DECLSPEC AG_TlistItem *AG_ComboSelectPointer(AG_Combo *, void *);
extern DECLSPEC AG_TlistItem *AG_ComboSelectText(AG_Combo *, const char *);
