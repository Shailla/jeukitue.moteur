...
extern DECLSPEC int AG_TablePoolAdd(AG_Table *, Uint, Uint);
extern DECLSPEC void AG_TablePoolFree(AG_Table *, Uint);
...
extern DECLSPEC void AG_TableSelectRow(AG_Table *, Uint);
extern DECLSPEC void AG_TableDeselectRow(AG_Table *, Uint);
extern DECLSPEC void AG_TableSelectAllRows(AG_Table *);
extern DECLSPEC void AG_TableDeselectAllRows(AG_Table *);
extern DECLSPEC int AG_TableRowSelected(AG_Table *, Uint);
