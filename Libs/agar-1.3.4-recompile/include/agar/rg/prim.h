...
__BEGIN_DECLS
extern DECLSPEC void RG_ColorRGB(struct rg_tile *, Uint8, Uint8, Uint8);
extern DECLSPEC void RG_ColorRGBA(struct rg_tile *, Uint8, Uint8, Uint8, Uint8);
...
extern DECLSPEC void RG_BlendRGB(AG_Surface *, int, int, enum rg_prim_blend_mode, Uint8, Uint8, Uint8, Uint8);
