...
__BEGIN_DECLS
extern DECLSPEC const char *rgTileSnapModes[];
extern DECLSPEC RG_Tile *RG_TileNew(struct rg_tileset *, const char *, Uint16, Uint16, Uint);
extern DECLSPEC void RG_TileInit(RG_Tile *, struct rg_tileset *, const char *);
extern DECLSPEC void RG_TileScale(struct rg_tileset *, RG_Tile *, Uint16, Uint16, Uint);
extern DECLSPEC void RG_TileGenerate(RG_Tile *);
extern DECLSPEC struct ag_window *RG_TileEdit(struct rg_tileset *, RG_Tile *);
extern DECLSPEC void RG_TileDestroy(RG_Tile *);
extern DECLSPEC void RG_TileSave(RG_Tile *, AG_DataSource *);
extern DECLSPEC int RG_TileLoad(RG_Tile *, AG_DataSource *);
extern DECLSPEC void RG_TileOpenMenu(struct rg_tileview *, int, int);
extern DECLSPEC void RG_TileCloseMenu(struct rg_tileview *);
extern DECLSPEC RG_TileElement *RG_TileFindElement(RG_Tile *, enum rg_tile_element_type, const char *);
extern DECLSPEC RG_TileElement *RG_TileAddPixmap(RG_Tile *, const char *, struct rg_pixmap *, int, int);
extern DECLSPEC RG_TileElement *RG_TileAddSketch(RG_Tile *, const char *, struct rg_sketch *, int, int);
extern DECLSPEC RG_TileElement *RG_TileAddFeature(RG_Tile *, const char *, void *, int, int);
extern DECLSPEC void RG_TileDelFeature(RG_Tile *, void *, int);
extern DECLSPEC void RG_TileDelPixmap(RG_Tile *, struct rg_pixmap *, int);
extern DECLSPEC void RG_TileDelSketch(RG_Tile *, struct rg_sketch *, int);
__END_DECLS
