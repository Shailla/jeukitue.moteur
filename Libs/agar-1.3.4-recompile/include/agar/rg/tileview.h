...
#define RG_TILEVIEW_SCALED_X(tv, x) (AGWIDGET(tv)->rView.x1 + (tv)->xoffs + (x)*(tv)->pxsz)
#define RG_TILEVIEW_SCALED_Y(tv, x) (AGWIDGET(tv)->rView.y1 + (tv)->yoffs + (y)*(tv)->pxsz)

/* Begin generated block */
__BEGIN_DECLS
extern DECLSPEC AG_WidgetClass rgTileviewClass;
extern DECLSPEC RG_Tileview *RG_TileviewNew(void *, RG_Tileset *, Uint);
extern DECLSPEC RG_TileviewTool *RG_TileviewRegTool(RG_Tileview *, const void *);
extern DECLSPEC void RG_TileviewSetTile(RG_Tileview *, RG_Tile *);
extern DECLSPEC void RG_TileviewSetZoom(RG_Tileview *, int, int);
extern DECLSPEC void RG_TileviewSetAutoRefresh(RG_Tileview *, int, int);
extern DECLSPEC void RG_TileviewColor3i(RG_Tileview *, Uint8, Uint8, Uint8);
extern DECLSPEC void RG_TileviewColor4i(RG_Tileview *, Uint8, Uint8, Uint8, Uint8);
extern DECLSPEC void RG_TileviewSDLColor(RG_Tileview *, AG_Color *, Uint8);
extern DECLSPEC void RG_TileviewAlpha(RG_Tileview *, Uint8);
extern DECLSPEC void RG_TileviewPixel2i(RG_Tileview *, int, int);
extern DECLSPEC void RG_TileviewRect2(RG_Tileview *, int, int, int, int);
extern DECLSPEC void RG_TileviewRect2o(RG_Tileview *, int, int, int, int);
extern DECLSPEC void RG_TileviewCircle2o(RG_Tileview *, int, int, int);
extern DECLSPEC void RG_TileviewHLine(RG_Tileview *, int, int, int);
extern DECLSPEC void RG_TileviewVLine(RG_Tileview *, int, int, int);
extern DECLSPEC RG_TileviewCtrl *RG_TileviewAddCtrl(RG_Tileview *, enum rg_tileview_ctrl_type, const char *, ...);
extern DECLSPEC void RG_TileviewDelCtrl(RG_Tileview *, RG_TileviewCtrl *);
extern DECLSPEC void RG_TileviewSelectTool(RG_Tileview *, RG_TileviewTool *);
extern DECLSPEC void RG_TileviewUnselectTool(RG_Tileview *);
extern DECLSPEC void RG_TileviewGenericMenu(RG_Tileview *, AG_MenuItem *);
