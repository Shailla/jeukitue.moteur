System.register(['angular2/platform/browser', 'angular2/http', 'angular2/router', './maps.service', './players.service', './dashboard.component', './maps.list.component', './players.list.component'], function(exports_1) {
