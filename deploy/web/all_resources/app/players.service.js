        ...
        execute: function() {
            PlayersService = (function () {
                function PlayersService(_http) {
                    ...
                    this.players = _http.get('users.json').map(function (response) { return response.json(); });
                }
                PlayersService.prototype.getPlayers = function () {
                    return this._http.get('users.json').map(function (response) { return response.json(); });
                };
