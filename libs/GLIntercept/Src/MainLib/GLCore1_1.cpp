...
//Generated built in wrappers
  ...
  GL_FUNCTION_WRAPPER(glClearColor,(GLclampf red, GLclampf green, GLclampf blue, GLclampf alpha), (red, green, blue, alpha), red);
  ...
  GL_FUNCTION_WRAPPER(glAlphaFunc,(GLenum func, GLclampf ref), (func, ref), func);
  ...
  GL_FUNCTION_WRAPPER(glClearDepth,(GLclampd depth), (depth), depth);
  GL_FUNCTION_WRAPPER(glDepthFunc,(GLenum func), (func), func);
  GL_FUNCTION_WRAPPER(glDepthMask,(GLboolean flag), (flag), flag);
  GL_FUNCTION_WRAPPER(glDepthRange,(GLclampd near_val, GLclampd far_val), (near_val, far_val), near_val);
  ...
  GL_FUNCTION_WRAPPER(glPrioritizeTextures,(GLsizei n, const GLuint *textures, const GLclampf *priorities), (n, textures, priorities), n);
