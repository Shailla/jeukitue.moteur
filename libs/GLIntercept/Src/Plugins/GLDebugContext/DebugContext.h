...
public:
  ...
  void (GLAPIENTRY *iglDebugMessageControlARB) (GLenum source, GLenum type, GLenum severity, GLsizei count, const GLuint * ids, GLboolean enabled);
  void (GLAPIENTRY *iglDebugMessageCallbackARB) (GLDEBUGPROCARB callback, GLvoid* userParam);
  ...
  public:
    ...
    GLDEBUGPROCARB m_appCallback;  //!< The application specified callback 
