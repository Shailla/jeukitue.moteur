...
__BEGIN_DECLS
extern DECLSPEC const AG_PropClass **agPropClasses;
extern DECLSPEC Uint agPropClassCount ;
extern DECLSPEC void AG_RegisterPropClass(const AG_PropClass *);
extern DECLSPEC void AG_UnregisterPropClass(const AG_PropClass *);
extern DECLSPEC int AG_PropLoad(void *, AG_DataSource *);
extern DECLSPEC int AG_PropSave(void *, AG_DataSource *);
extern DECLSPEC void AG_PropDestroy(AG_Prop *);
extern DECLSPEC AG_Prop *AG_CopyProp(const AG_Prop *);
extern DECLSPEC AG_Prop *AG_SetProp(void *, const char *, enum ag_prop_type, ...);
extern DECLSPEC AG_Prop *AG_GetProp(void *, const char *, int, void *);
extern DECLSPEC AG_Prop *AG_FindProp(void *, const char *, int, void *);
extern DECLSPEC void AG_PropPrint(char *, size_t, void *, const char *) BOUNDED_ATTRIBUTE(__string__, 1, 2);
extern DECLSPEC int AG_PropCopyPath(char *, size_t, void *, const char *) BOUNDED_ATTRIBUTE(__string__, 1, 2);
extern DECLSPEC size_t AG_GetStringCopy(void *, const char *, char *, size_t);
extern DECLSPEC AG_Prop *AG_SetString(void *, const char *, const char *, ...);
extern DECLSPEC int AG_PropDefined(void *, const char *);
/********************
 * Get/Set Routines *
 ********************/
