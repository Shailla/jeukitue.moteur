...
extern DECLSPEC void AG_ScheduleTimeout(void *, AG_Timeout *, Uint32, int);
extern DECLSPEC int AG_TimeoutIsScheduled(void *, AG_Timeout *);
...
extern DECLSPEC void AG_LockTimeouts(void *);
extern DECLSPEC void AG_UnlockTimeouts(void *);
