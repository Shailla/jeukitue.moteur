...
extern DECLSPEC void AG_IconSetSurface(AG_Icon *, AG_Surface *);
extern DECLSPEC void AG_IconSetSurfaceNODUP(AG_Icon *, AG_Surface *);
extern DECLSPEC void AG_IconSetText(AG_Icon *, const char *, ...) FORMAT_ATTRIBUTE(printf, 2, 3) NONNULL_ATTRIBUTE(2);
extern DECLSPEC void AG_IconSetBackgroundFill(AG_Icon *, int, Uint32);
__END_DECLS
