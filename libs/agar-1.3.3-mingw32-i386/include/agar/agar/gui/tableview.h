...
__BEGIN_DECLS
extern DECLSPEC AG_WidgetClass agTableviewClass;
extern DECLSPEC AG_Tableview *AG_TableviewNew(void *, Uint, AG_TableviewDataFn, AG_TableviewSortFn);
extern DECLSPEC void AG_TableviewSizeHint(AG_Tableview *, const char *, int);
#define AG_TableviewPrescale AG_TableviewSizeHint
extern DECLSPEC void AG_TableviewSetUpdate(AG_Tableview *, Uint);
extern DECLSPEC void AG_TableviewSetColHeight(AG_Tableview *, int);
extern DECLSPEC AG_TableviewCol *AG_TableviewColAdd(AG_Tableview *, int, AG_TableviewColID, const char *, const char *);
extern DECLSPEC void AG_TableviewColSelect(AG_Tableview *, AG_TableviewColID);
extern DECLSPEC AG_TableviewRow *AG_TableviewRowGet(AG_Tableview *, AG_TableviewRowID);
extern DECLSPEC AG_TableviewRow *AG_TableviewRowAdd(AG_Tableview *, Uint, AG_TableviewRow *, void *, AG_TableviewRowID, ...);
extern DECLSPEC AG_TableviewRow *AG_TableviewRowSelected(AG_Tableview *);
extern DECLSPEC void AG_TableviewRowDel(AG_Tableview *, AG_TableviewRow *);
extern DECLSPEC void AG_TableviewRowDelAll(AG_Tableview *);
extern DECLSPEC void AG_TableviewRowRestoreAll(AG_Tableview *);
extern DECLSPEC void AG_TableviewRowSelect(AG_Tableview *, AG_TableviewRow *);
extern DECLSPEC void AG_TableviewRowSelectAll(AG_Tableview *, AG_TableviewRow *);
extern DECLSPEC void AG_TableviewRowDeselectAll(AG_Tableview *, AG_TableviewRow *);
extern DECLSPEC void AG_TableviewRowExpand(AG_Tableview *, AG_TableviewRow *);
extern DECLSPEC void AG_TableviewRowCollapse(AG_Tableview *, AG_TableviewRow *);
extern DECLSPEC void AG_TableviewRowExpandAll(AG_Tableview *, AG_TableviewRow *);
extern DECLSPEC void AG_TableviewRowCollapseAll(AG_Tableview *, AG_TableviewRow *);
extern DECLSPEC void AG_TableviewCellPrintf(AG_Tableview *, AG_TableviewRow *, int, const char *, ...);
#define AG_TableviewRowGetID(ROW) (*(AG_TableviewRowID *)(ROW))
#define AG_TableviewRowDeselect(TV, ROW) ((ROW)->selected = 0)
#define AG_TableviewRowToggle(TV, ROW) do { if (NULL == (ROW)) break if ((ROW)->flags & AG_TABLEVIEW_ROW_EXPANDED) AG_TableviewRowCollapse(TV, (ROW)); else AG_TableviewRowExpand(TV, (ROW)); } while (0)
#define AG_TableviewRowIDAdd(TV, ID, IDNEW, USERP) AG_TableviewRowAdd((TV), 0, AG_TableviewRowGet((TV),(ID)), (USERP), (IDNEW), -1)
#define AG_TableviewRowIDDel(TV, ID) AG_TableviewRowDelete((TV), AG_TableviewRowGet((TV), (ID)))
#define AG_TableviewRowIDSelect(TV, ID) AG_TableviewRowSelect((TV), AG_TableviewRowGet((TV), (ID)))
#define AG_TableviewRowIDDeselect(TV, ID) do { AG_TableviewRow *_row = AG_TableviewRowGet((TV), (ID)); if (_row != NULL) _row->selected = 0; } while(0)
#define AG_TableviewRowIDSelectAll(TV, ID) AG_TableviewRowSelectAll((TV), AG_TableviewRowGet((TV), (ID)))
#define AG_TableviewRowIDDeselect_all(TV, ID) AG_TableviewRowDeselectAll((TV), AG_TableviewRowGet((TV), (ID)))
#define AG_TableviewRowIDExpand(TV, ID) AG_TableviewRowExpand((TV), AG_TableviewRowGet((TV), (ID)))
#define AG_TableviewRowIDCollapse(TV, ID) AG_TableviewRowCollapse((TV), AG_TableviewRowGet((TV), (ID)))
#define AG_TableviewRowIDToggle(TV, ID) do { AG_TableviewRow *_row = AG_TableviewRowGet((TV), (ID)); if (NULL == _row) break; if (_row->flags & AG_TABLEVIEW_ROW_EXPANDED) { AG_TableviewRowCollapse((TV), _row); } else { AG_TableviewRowExpand((TV), _row); } } while(0)
__END_DECLS
