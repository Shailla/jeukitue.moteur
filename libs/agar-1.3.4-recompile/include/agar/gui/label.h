...
extern DECLSPEC AG_Label *AG_LabelNewPolledMT(void *, Uint, AG_Mutex *, const char *, ...) NONNULL_ATTRIBUTE(3);
extern DECLSPEC AG_Label *AG_LabelNewStatic(void *, Uint, const char *, ...) FORMAT_ATTRIBUTE(printf, 3, 4);
extern DECLSPEC AG_Label *AG_LabelNewStaticString(void *, Uint, const char *);
#define AG_LabelNew AG_LabelNewStatic
#define AG_LabelNewString AG_LabelNewStaticString
extern DECLSPEC void AG_LabelString(AG_Label *, const char *);
extern DECLSPEC void AG_LabelText(AG_Label *, const char *, ...) FORMAT_ATTRIBUTE(printf, 2, 3) NONNULL_ATTRIBUTE(2);
...
extern DECLSPEC void AG_LabelFlagNew(AG_Label *, Uint, const char *, AG_VariableType, Uint32);
#define AG_LabelFlag(lbl,i,s,v) AG_LabelFlagNew((lbl),(i),(s),AG_VARIABLE_P_FLAG,(Uint)(v))
#define AG_LabelFlag8(lbl,i,s,v) AG_LabelFlagNew((lbl),(i),(s),AG_VARIABLE_P_FLAG8,(Uint8)(v))
#define AG_LabelFlag16(lbl,i,s,v) AG_LabelFlagNew((lbl),(i),(s),AG_VARIABLE_P_FLAG16,(Uint16)(v))
#define AG_LabelFlag32(lbl,i,s,v) AG_LabelFlagNew((lbl),(i),(s),AG_VARIABLE_P_FLAG32,(Uint32)(v))
#define AG_LABEL_ARG(lbl,_type) (*(_type *)lbl->poll.ptrs[fPos])
extern DECLSPEC void AG_RegisterLabelFormat(const char *, AG_LabelFormatFn);
extern DECLSPEC void AG_RegisterBuiltinLabelFormats(void);
#ifdef AG_LEGACY
