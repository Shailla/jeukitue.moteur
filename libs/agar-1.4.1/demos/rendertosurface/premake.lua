...
--     $ make proj
--
project.name = "rendertosurface"
package = newpackage()
package.name = "rendertosurface"
package.kind = "winexe"
package.language = "c"
package.guid = "ea1d0404-9567-47ab-a531-f6be0929ddfb"
...
tinsert(package.includepaths,{"/home/vedge/src/agar-1.4.1/demos/rendertosurface"})
