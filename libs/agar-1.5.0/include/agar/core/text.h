...
extern DECLSPEC void AG_TextClear(AG_Text *);
extern DECLSPEC int AG_TextSet(AG_Text *, const char *, ...) FORMAT_ATTRIBUTE(__printf__, 2, 3);
extern DECLSPEC int AG_TextSetEnt(AG_Text *, enum ag_language, const char *, ...) FORMAT_ATTRIBUTE(__printf__, 3, 4);
extern DECLSPEC int AG_TextSetEntS(AG_Text *, enum ag_language, const char *);
extern DECLSPEC int AG_TextSetLangISO(AG_Text *, const char *);
extern DECLSPEC const char *AG_TextGetLangISO(AG_Text *);
extern DECLSPEC AG_Text *AG_TextDup(AG_Text *);
extern DECLSPEC int AG_TextLoad(AG_Text *, AG_DataSource *);
extern DECLSPEC void AG_TextSave(AG_DataSource *, AG_Text *);
