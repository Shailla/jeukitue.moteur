...
extern DECLSPEC AG_Cursor *AG_SDL_CreateCursor(void *, Uint, Uint, const Uint8 *, const Uint8 *, int, int);
...
extern DECLSPEC void AG_SDL_GetPrefDisplaySettings(void *, Uint *, Uint *, int *);
