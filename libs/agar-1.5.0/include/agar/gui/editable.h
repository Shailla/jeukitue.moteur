...
extern DECLSPEC void AG_EditableBindEncoded(AG_Editable *, const char *, char *, size_t);
extern DECLSPEC void AG_EditableBindText(AG_Editable *, AG_Text *);
extern DECLSPEC void AG_EditableSetLang(AG_Editable *, enum ag_language);
extern DECLSPEC AG_EditableBuffer *AG_EditableGetBuffer(AG_Editable *);
extern DECLSPEC void AG_EditableReleaseBuffer(AG_Editable *, AG_EditableBuffer *);
extern DECLSPEC void AG_EditableClearBuffer(AG_Editable *, AG_EditableBuffer *);
extern DECLSPEC int AG_EditableGrowBuffer(AG_Editable *, AG_EditableBuffer *, Uint32 *, size_t);
extern DECLSPEC int AG_EditableCut(AG_Editable *, AG_EditableBuffer *, AG_EditableClipboard *);
extern DECLSPEC int AG_EditableCopy(AG_Editable *, AG_EditableBuffer *, AG_EditableClipboard *);
extern DECLSPEC void AG_EditableCopyChunk(AG_Editable *, AG_EditableClipboard *, Uint32 *, size_t);
extern DECLSPEC int AG_EditablePaste(AG_Editable *, AG_EditableBuffer *, AG_EditableClipboard *);
extern DECLSPEC int AG_EditableDelete(AG_Editable *, AG_EditableBuffer *);
extern DECLSPEC void AG_EditableSelectAll(AG_Editable *, AG_EditableBuffer *);
...
extern DECLSPEC void AG_EditableInitClipboards(void);
extern DECLSPEC void AG_EditableDestroyClipboards(void);
extern DECLSPEC int AG_EditableMapPosition(AG_Editable *, AG_EditableBuffer *, int, int, int *);
extern DECLSPEC void AG_EditableMoveCursor(AG_Editable *, AG_EditableBuffer *, int, int);
extern DECLSPEC int AG_EditableSetCursorPos(AG_Editable *, AG_EditableBuffer *, int);
