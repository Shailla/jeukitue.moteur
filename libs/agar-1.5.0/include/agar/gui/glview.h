...
extern DECLSPEC void AG_GLViewOverlayFn(void *, AG_EventFn, const char *, ...);
extern DECLSPEC void AG_GLViewScaleFn(void *, AG_EventFn, const char *, ...);
extern DECLSPEC void AG_GLViewKeydownFn(void *, AG_EventFn, const char *, ...);
extern DECLSPEC void AG_GLViewKeyupFn(void *, AG_EventFn, const char *, ...);
