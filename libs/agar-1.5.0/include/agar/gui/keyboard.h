...
extern DECLSPEC const char *AG_LookupKeyName(AG_KeySym);
extern DECLSPEC AG_KeySym AG_LookupKeySym(const char *);
extern DECLSPEC void AG_InitGlobalKeys(void);
extern DECLSPEC void AG_DestroyGlobalKeys(void);
extern DECLSPEC void AG_BindStdGlobalKeys(void);
extern DECLSPEC void AG_BindGlobalKey(AG_KeySym, AG_KeyMod, void (*)(void));
extern DECLSPEC void AG_BindGlobalKeyEv(AG_KeySym, AG_KeyMod, void (*)(AG_Event *));
extern DECLSPEC int AG_UnbindGlobalKey(AG_KeySym, AG_KeyMod);
extern DECLSPEC void AG_ClearGlobalKeys(void);
extern DECLSPEC int AG_ExecGlobalKeys(AG_KeySym, AG_KeyMod);
