...
extern DECLSPEC void AG_MouseButtonUpdate(AG_Mouse *, AG_MouseButtonAction, int);
extern DECLSPEC void AG_ProcessMouseMotion(struct ag_window *, int, int, int, int, Uint);
extern DECLSPEC void AG_ProcessMouseButtonUp(struct ag_window *, int, int, AG_MouseButton);
extern DECLSPEC void AG_ProcessMouseButtonDown(struct ag_window *, int, int, AG_MouseButton);
