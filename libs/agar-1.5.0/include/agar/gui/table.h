...
extern DECLSPEC void AG_TableSetColClickFn(AG_Table *, AG_EventFn, const char *, ...);
extern DECLSPEC void AG_TableSetCellClickFn(AG_Table *, AG_EventFn, const char *, ...);
extern DECLSPEC void AG_TableSetRowDblClickFn(AG_Table *, AG_EventFn, const char *, ...);
extern DECLSPEC void AG_TableSetColDblClickFn(AG_Table *, AG_EventFn, const char *, ...);
extern DECLSPEC void AG_TableSetCellDblClickFn(AG_Table *, AG_EventFn, const char *, ...);
extern DECLSPEC void AG_TableSetColHeight(AG_Table *, int);
extern DECLSPEC void AG_TableSetRowHeight(AG_Table *, int);
extern DECLSPEC void AG_TableSetColMin(AG_Table *, int);
extern DECLSPEC void AG_TableSetDefaultColWidth(AG_Table *, int);
extern DECLSPEC void AG_TableSetSelectionMode(AG_Table *, enum ag_table_selmode);
extern DECLSPEC void AG_TableSetSelectionColor(AG_Table *, Uint8, Uint8, Uint8, Uint8);
extern DECLSPEC void AG_TableSetColumnAction(AG_Table *, Uint);
extern DECLSPEC void AG_TableClear(AG_Table *);
extern DECLSPEC void AG_TableBegin(AG_Table *);
extern DECLSPEC void AG_TableEnd(AG_Table *);
extern DECLSPEC void AG_TableSort(AG_Table *);
extern DECLSPEC void AG_TableInitCell(AG_Table *, AG_TableCell *);
extern DECLSPEC void AG_TablePrintCell(const AG_TableCell *, char *, size_t);
extern DECLSPEC void AG_TableFreeCell(AG_Table *, AG_TableCell *);
extern DECLSPEC int AG_TableAddRow(AG_Table *, const char *, ...);
extern DECLSPEC void AG_TableSelectRow(AG_Table *, int);
extern DECLSPEC void AG_TableDeselectRow(AG_Table *, int);
extern DECLSPEC void AG_TableSelectAllRows(AG_Table *);
extern DECLSPEC void AG_TableDeselectAllRows(AG_Table *);
extern DECLSPEC int AG_TableRowSelected(AG_Table *, int);
extern DECLSPEC int AG_TableAddCol(AG_Table *, const char *, const char *, int (*)(const void *, const void *));
extern DECLSPEC void AG_TableSelectAllCols(AG_Table *);
extern DECLSPEC void AG_TableDeselectAllCols(AG_Table *);
extern DECLSPEC void AG_TableRedrawCells(AG_Table *);
extern DECLSPEC int AG_TableCompareCells(const AG_TableCell *, const AG_TableCell *);
extern DECLSPEC AG_MenuItem *AG_TableSetPopup(AG_Table *, int, int);
extern DECLSPEC int AG_TableSaveASCII(AG_Table *, FILE *, char);
