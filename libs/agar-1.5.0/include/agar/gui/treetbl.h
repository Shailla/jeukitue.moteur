...
extern DECLSPEC void AG_TreetblSetColHeight(AG_Treetbl *, int);
extern DECLSPEC void AG_TreetblSetSortCol(AG_Treetbl *, AG_TreetblCol *);
extern DECLSPEC void AG_TreetblSetSortMode(AG_Treetbl *, enum ag_treetbl_sort_mode mode);
extern DECLSPEC void AG_TreetblSetExpanderCol(AG_Treetbl *, AG_TreetblCol *);
extern DECLSPEC AG_TreetblCol *AG_TreetblAddCol(AG_Treetbl *, int, const char *, const char *, ...);
extern DECLSPEC void AG_TreetblSelectCol(AG_Treetbl *, AG_TreetblCol *);
extern DECLSPEC int AG_TreetblSelectColID(AG_Treetbl *, int);
extern DECLSPEC void AG_TreetblDeselectCol(AG_Treetbl *, AG_TreetblCol *);
extern DECLSPEC int AG_TreetblDeselectColID(AG_Treetbl *, int);
extern DECLSPEC AG_TreetblRow *AG_TreetblAddRow(AG_Treetbl *, AG_TreetblRow *, int, const char *, ...);
extern DECLSPEC void AG_TreetblDelRow(AG_Treetbl *, AG_TreetblRow *);
extern DECLSPEC void AG_TreetblClearRows(AG_Treetbl *);
extern DECLSPEC void AG_TreetblRestoreRows(AG_Treetbl *);
extern DECLSPEC void AG_TreetblSelectRow(AG_Treetbl *, AG_TreetblRow *);
extern DECLSPEC void AG_TreetblDeselectRow(AG_Treetbl *, AG_TreetblRow *);
extern DECLSPEC void AG_TreetblSelectAll(AG_Treetbl *, AG_TreetblRow *);
extern DECLSPEC void AG_TreetblDeselectAll(AG_Treetbl *, AG_TreetblRow *);
