...
extern DECLSPEC void M_PlotterSetDefaultFont(M_Plotter *, const char *, int);
extern DECLSPEC void M_PlotterSetDefaultColor(M_Plotter *, int, Uint8, Uint8, Uint8);
extern DECLSPEC void M_PlotterSetDefaultScale(M_Plotter *, M_Real, M_Real);
extern DECLSPEC M_Plot *M_PlotNew(M_Plotter *, enum m_plot_type);
extern DECLSPEC M_PlotLabel *M_PlotLabelNew(M_Plot *, enum m_plot_label_type, Uint, Uint, const char *, ...);
extern DECLSPEC void M_PlotLabelSetText(M_Plot *, M_PlotLabel *, const char *, ...);
extern DECLSPEC M_PlotLabel *M_PlotLabelReplace(M_Plot *, enum m_plot_label_type, Uint, Uint, const char *, ...);
extern DECLSPEC void M_PlotClear(M_Plot *);
extern DECLSPEC M_Plot *M_PlotFromReal(M_Plotter *, enum m_plot_type, const char *, M_Real *);
extern DECLSPEC M_Plot *M_PlotFromInt(M_Plotter *, enum m_plot_type, const char *, int *);
extern DECLSPEC M_Plot *M_PlotFromDerivative(M_Plotter *, enum m_plot_type, M_Plot *);
extern DECLSPEC M_Plot *M_PlotFromVariableVFS(M_Plotter *, enum m_plot_type, const char *, void *, const char *);
extern DECLSPEC struct ag_window *M_PlotSettings(M_Plot *);
extern DECLSPEC void M_PlotSetColor(M_Plot *, Uint8, Uint8, Uint8);
extern DECLSPEC void M_PlotSetLabel(M_Plot *, const char *, ...);
extern DECLSPEC void M_PlotUpdateLabel(M_Plot *);
extern DECLSPEC void M_PlotSetScale(M_Plot *, M_Real, M_Real);
extern DECLSPEC void M_PlotSetXoffs(M_Plot *, int);
extern DECLSPEC void M_PlotSetYoffs(M_Plot *, int);
extern DECLSPEC void M_PlotReal(M_Plot *, M_Real);
