...
extern DECLSPEC int M_ReadVector2v(AG_DataSource *, M_Vector2 *);
extern DECLSPEC int M_ReadVector3v(AG_DataSource *, M_Vector3 *);
extern DECLSPEC int M_ReadVector4v(AG_DataSource *, M_Vector4 *);
extern DECLSPEC void M_WriteVector2(AG_DataSource *, const M_Vector2 *);
extern DECLSPEC void M_WriteVector3(AG_DataSource *, const M_Vector3 *);
extern DECLSPEC void M_WriteVector4(AG_DataSource *, const M_Vector4 *);
