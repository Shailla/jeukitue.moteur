...
BOOL CDlgOptAbout::OnInitDialog() 
{
	...
	s += _T("<font size='14' face='Courier New' color='209,180,50'>VERSION 3.2</font><p>");
	s += _T("Copyright (c) 2000 - 2012 Artpol Software - Tadeusz Dracz<p>");
