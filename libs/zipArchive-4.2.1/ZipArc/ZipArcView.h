...
protected:
	...
	bool FillAvWithFh(CZipArcViewCache& av, ZIP_INDEX_TYPE idx, bool bFast = false);
...
public:
	...
	void SelectItem(ZIP_INDEX_TYPE iItem, bool bSelect);
...
protected:
	...
	afx_msg LRESULT OnRedisplay( WPARAM uParam, LPARAM lParam );
	...
	afx_msg LRESULT OnSetreport( WPARAM uParam, LPARAM lParam );
	afx_msg void OnSelectall();
	afx_msg LRESULT OnShowhideview( WPARAM uParam, LPARAM lParam );
	afx_msg BOOL OnEraseBkgnd(CDC* pDC);
	afx_msg void OnPaint();
	afx_msg void OnUpdateViewFileinfo(CCmdUI* pCmdUI);
	afx_msg LRESULT OnModifymenu( WPARAM uParam, LPARAM lParam );
