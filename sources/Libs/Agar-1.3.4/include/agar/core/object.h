...
#define AGOBJECT_FOREACH_VARIABLE(var, i, obj) for ((i) = 0; ((i) < AGOBJECT(obj)->nVars) && ((var) = &AGOBJECT(obj)->vars[i]); (i)++)
...
extern DECLSPEC void AG_ObjectFreeVariables(void *);
...
extern DECLSPEC int AG_ObjectLoadVariables(void *, AG_DataSource *);
...
#endif 
#ifdef AG_LEGACY
extern DECLSPEC void AG_ObjectMove(void *, void *) DEPRECATED_ATTRIBUTE;
