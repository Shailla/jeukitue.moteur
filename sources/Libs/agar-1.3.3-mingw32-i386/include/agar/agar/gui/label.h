...
extern DECLSPEC void AG_LabelFlagNew(AG_Label *, Uint, const char *, enum ag_widget_binding_type, Uint32);
#define AG_LabelFlag(lbl,i,s,v) AG_LabelFlagNew((lbl),(i),(s),AG_WIDGET_FLAG,(Uint)(v))
#define AG_LabelFlag8(lbl,i,s,v) AG_LabelFlagNew((lbl),(i),(s),AG_WIDGET_FLAG8,(Uint8)(v))
#define AG_LabelFlag16(lbl,i,s,v) AG_LabelFlagNew((lbl),(i),(s),AG_WIDGET_FLAG16,(Uint16)(v))
#define AG_LabelFlag32(lbl,i,s,v) AG_LabelFlagNew((lbl),(i),(s),AG_WIDGET_FLAG32,(Uint32)(v))
