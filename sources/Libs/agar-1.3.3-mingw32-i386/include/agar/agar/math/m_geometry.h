...
#define M_TRIANGLE2_INITIALIZER(ax,ay,bx,by,cx,cy) { M_LineFromPts2(ax,ay), M_LineFromPts2(bx,by), M_LineFromPts2(cx,cy) }
#define M_TRIANGLE3_INITIALIZER(ax,ay,az,bx,by,bz,cx,cy,cz) { M_LineFromPts3(ax,ay,az), M_LineFromPts3(bx,by,bz), M_LineFromPts3(cx,cy,cz) }
...
#define M_RECTANGLE2_INITIALIZER(ax,ay,bx,by,cx,cy,dx,dy) { M_LineFromPts2(ax,ay), M_LineFromPts2(bx,by), M_LineFromPts2(cx,cy), M_LineFromPts2(dx,dy) }
#define M_RECTANGLE_INITIALIZER(ax,ay,az,bx,by,bz,cx,cy,cz,dx,dy,dz) { M_LineFromPts3(ax,ay,az), M_LineFromPts3(bx,by,bz), M_LineFromPts3(cx,cy,cz), M_LineFromPts3(dx,dy,dz) }
