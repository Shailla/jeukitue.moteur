...
extern DECLSPEC void VG_ToolBindKey(void *, SDLMod, SDLKey, int (*)(VG_Tool *, SDLKey, int, void *), void *);
extern DECLSPEC void VG_ToolBindMouseButton(void *, int, int (*)(VG_Tool *, int, int, float, float, void *), void *);
extern DECLSPEC void VG_ToolUnbindKey(void *, SDLMod, SDLKey);
__END_DECLS
