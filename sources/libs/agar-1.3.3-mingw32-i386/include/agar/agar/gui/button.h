...
extern DECLSPEC AG_Button *AG_ButtonNew(void *, Uint, const char *, ...);
extern DECLSPEC AG_Button *AG_ButtonNewFn(void *, Uint, const char *, AG_EventFn, const char *, ...);
extern DECLSPEC AG_Button *AG_ButtonNewBool(void *, Uint, const char *, AG_WidgetBindingType, void *);
#define AG_ButtonNewInt(b,f,c,p) AG_ButtonNewBool((b),(f),(c),AG_WIDGET_INT,(p))
#define AG_ButtonNewUint8(b,f,c,p) AG_ButtonNewBool((b),(f),(c),AG_WIDGET_UINT8,(p))
#define AG_ButtonNewUint16(b,f,c,p) AG_ButtonNewBool((b),(f),(c),AG_WIDGET_UINT16,(p))
#define AG_ButtonNewUint32(b,f,c,p) AG_ButtonNewBool((b),(f),(c),AG_WIDGET_UINT32,(p))
