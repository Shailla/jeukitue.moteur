...
extern DECLSPEC AG_Pixmap *AG_PixmapFromSurface(void *, Uint, AG_Surface *);
extern DECLSPEC AG_Pixmap *AG_PixmapFromSurfaceCopy(void *, Uint, AG_Surface *);
extern DECLSPEC AG_Pixmap *AG_PixmapFromSurfaceScaled(void *, Uint, AG_Surface *, Uint, Uint);
extern DECLSPEC AG_Pixmap *AG_PixmapFromBMP(void *, Uint, const char *);
extern DECLSPEC int AG_PixmapAddSurface(AG_Pixmap *, AG_Surface *);
extern DECLSPEC int AG_PixmapAddSurfaceFromBMP(AG_Pixmap *, const char *);
extern DECLSPEC int AG_PixmapAddSurfaceCopy(AG_Pixmap *, AG_Surface *);
extern DECLSPEC int AG_PixmapAddSurfaceScaled(AG_Pixmap *, AG_Surface *, Uint, Uint);
#define AG_PixmapReplaceSurface(px,name,su) AG_WidgetReplaceSurface((px),(name),(su))
#define AG_PixmapUpdateSurface(px,name) AG_WidgetUpdateSurface((px),(name))
extern DECLSPEC void AG_PixmapReplaceSurfaceScaled(AG_Pixmap *, int, AG_Surface *, Uint, Uint);
