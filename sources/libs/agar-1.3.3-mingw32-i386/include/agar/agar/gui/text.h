...
extern DECLSPEC int agFreetype;
...
extern DECLSPEC int AG_TextFontLookup(const char *, int, Uint);
...
extern DECLSPEC AG_Glyph *AG_TextRenderGlyph(Uint32);
extern DECLSPEC void AG_TextUnusedGlyph(AG_Glyph *);
extern DECLSPEC void AG_ClearGlyphCache(void);
...
#define AG_TextMsgFromError() AG_TextMsg(AG_MSG_ERROR, "%s", AG_GetError())
