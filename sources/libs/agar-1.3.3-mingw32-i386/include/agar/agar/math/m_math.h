...
# define M_Sign(x) ((x)>0.0l ? 1.0l : ((x)<0.0l ? -1.0l : 0.0l))
...
# define M_Sign(x) ((x)>0.0 ? 1.0 : ((x)<0.0 ? -1.0 : 0.0))
...
# define M_Sign(x) ((x)>0.0f ? 1.0f : ((x)<0.0f ? -1.0f : 0.0f))
...
extern DECLSPEC void M_CopyReal(AG_DataSource *, M_Real *);
extern DECLSPEC void M_WriteReal(AG_DataSource *, M_Real);
extern DECLSPEC M_Complex M_ReadComplex(AG_DataSource *);
extern DECLSPEC void M_CopyComplex(AG_DataSource *, M_Complex *);
extern DECLSPEC void M_WriteComplex(AG_DataSource *, M_Complex);
...
extern DECLSPEC int M_HeapSort(void *, size_t, size_t, int (*)(const void *, const void *));
extern DECLSPEC void M_QSort(void *, size_t, size_t, M_Real (*)(const void *, const void *));
