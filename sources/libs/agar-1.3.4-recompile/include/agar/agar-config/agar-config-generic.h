...
#define GENERIC_USAGE_STRING "Usage: %s [--help] [--version] [--release] [--cflags] [--libs] " "[--prefix] [--sysconfdir] [--incldir] [--libdir] [--sharedir] " "[--ttfdir] [--localedir] "

#define GENERIC_STRING_OPTS { "--version", VERSION }, { "--release", RELEASE }, { "--prefix", PREFIX }, { "--sysconfdir",SYSCONFDIR }, { "--incldir", INCLDIR }, { "--libdir", LIBDIR }, { "--sharedir", SHAREDIR }, { "--ttfdir", TTFDIR }, { "--localedir", LOCALEDIR }
