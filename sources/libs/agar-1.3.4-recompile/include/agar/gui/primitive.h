...
typedef struct ag_primitive_ops {
	...
	void (*BoxDisabled)(void *, AG_Rect r, int z, Uint32 c1, Uint32 c2);
...
#define AG_DrawBoxDisabled agPrim.BoxDisabled
...
__BEGIN_DECLS
extern DECLSPEC AG_PrimitiveOps agPrim;
extern DECLSPEC void AG_InitPrimitives(void);
__END_DECLS
