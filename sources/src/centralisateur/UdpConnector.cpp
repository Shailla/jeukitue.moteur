...
/**
    Constructeur
    portLocal : num�ro du port d'�coute de la facade
*/
...
/**
	Connection � une entit� distante
	ip: adresse IP de l'entit� distante
	port: port de l'entit� distante
*/
...
int UdpConnector::receive() {
    ...
    while(m_isAlive) {
		...
		int numReady = SDLNet_CheckSockets( m_socketSet, 1000 );	// Nombre de sockets ayant une activit� d�tect�e
