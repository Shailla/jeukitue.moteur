...
public:
	enum {
		...
		CODE_D_ListJoueurs = 101,	// Liste des joueurs connect�s
		...
		CODE_U_Signalement = 200,	// Signalement de pr�sence au serveur centralisateur
		CODE_U_PingAck = 201,		// R�ponse � une demande de ping du serveur centralisateur
		CODE_U_ListRequest = 202,	// Demande de la liste des connect�s
