...
class ValeurFloat : public Valeur {
	float _valeur;
public:
	ValeurFloat(AbstractBranche* parent, int valeurId, const std::string& valeurName, DONNEE_TYPE valeurType, UPDATE_MODE updateMode, int tmpRef, int revision, float valeur);
	virtual ~ValeurFloat();
