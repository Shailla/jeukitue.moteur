...
class ValeurString : public Valeur {
	std::string _valeur;
public:
	ValeurString(AbstractBranche* parent, int valeurId, const std::string& valeurName, DONNEE_TYPE valeurType, UPDATE_MODE updateMode, int tmpRef, int revision, const std::string& valeur);
