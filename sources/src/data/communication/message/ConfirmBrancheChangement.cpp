...
ConfirmBrancheChangement::ConfirmBrancheChangement(istringstream& in) {
	unserialize(in);
}

ConfirmBrancheChangement::ConfirmBrancheChangement(const vector<int>& brancheId, int revision) {
