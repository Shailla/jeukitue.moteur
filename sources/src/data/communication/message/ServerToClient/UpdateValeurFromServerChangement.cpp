...
UpdateValeurFromServerChangement::UpdateValeurFromServerChangement(istringstream& in) : Changement("UpdateValeurChangement", PRIORITY_UpdateValeurFromServerChangement) {
	unserialize(in);
}
