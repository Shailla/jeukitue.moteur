...
// géo. N'effectue cette mesure que pour des distances inf�rieures � 'dist'
...
void CGeoObject::gereContactPlayer(float positionPlayer[3], CPlayer *player, float deltaTime) {
