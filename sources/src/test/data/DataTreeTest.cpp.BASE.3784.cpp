...
void DataTreeTest::multiClientsTests() {
	...
	// Vérifie que le serveur et client-1 ont exactement le même arbre
	ASSERT_EQUAL(((AbstractBranche&)serverTree.getRoot()).print(distantClient1, 0, false), ((AbstractBranche&)client1Tree.getRoot()).print(0, 0, false), "Les abres client-1 et serveur devraient être identiques");
	...
	ASSERT_EQUAL(((AbstractBranche&)serverTree.getRoot()).print(distantClient1, 0, false), ((AbstractBranche&)client1Tree.getRoot()).print(0, 0, false), "Les abres serveur et client-1 devraient être identiques");
	ASSERT_EQUAL(((AbstractBranche&)serverTree.getRoot()).print(distantClient0, 0, false), ((AbstractBranche&)client0Tree.getRoot()).print(0, 0, false), "Les abres serveur et client-0 devraient être identiques");
	ASSERT_EQUAL(((AbstractBranche&)client0Tree.getRoot()).print(0, 0, false), ((AbstractBranche&)client1Tree.getRoot()).print(0, 0, false), "Les abres client-0 et client-0 devraient être identiques");
