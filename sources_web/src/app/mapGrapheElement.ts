...
export class MapGrapheElement {
  ...
  fromJson(jsonObject: any) {
    ...
    this.hidden = jsonObject.caracs.hidden.caracValue;
    this.highlighted = jsonObject.caracs.highlighted.caracValue;
  ...
  updateMapElement(mapElement: MapElement) {
    this.elements.forEach(element => {
      if (element.id == mapElement.id) {
        ...
        element.hidden = mapElement.caracs['hidden'].caracValue;
        element.highlighted = mapElement.caracs['highlighted'].caracValue;
      }
