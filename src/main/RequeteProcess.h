...
class CRequeteProcess
{
	...
	bool m_bOpenMapLocal;	// Indique une demande d'ouvrir la MAP nommée dans m_MapAOuvrir
...
public:
	...
	bool isOuvreMapLocal();					// Intéroge sur la présence d'une demande d'ouverture de MAP en jeu local
