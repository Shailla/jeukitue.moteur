...
const int Controller::OpenOneSceneMapAction = 5;
const int Controller::QuitAction = 6;
const int Controller::ConnectCentralisateurAction = 7;
...
void Controller::executeAction(AG_Event *event)
{
	...
	case OpenOneSceneMapAction:
        {
            char* mapName = AG_STRING(2);
            AG_TextMsg(AG_MSG_INFO, "Ouverture de la Map : %s!", mapName);
        }
        break;
